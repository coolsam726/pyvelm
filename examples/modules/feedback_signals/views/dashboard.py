    ...
    .views(
        ...
        .widgets(
            [
                ...
                LinkWidget.make("capture")
                .title("Share feedback")
                .subtitle("Capture")
                .description(
                    "Open the narrative-first intake form for a new story."
                )
                .url("/web/feedback_signals/capture"),
                LinkWidget.make("review")
                .title("Review signals")
                .subtitle("Human verification")
                .description(
                    "Confirm or correct LLM-derived tone, topics, and sentiment."
                )
                .url("/web/feedback_signals/review"),
                LinkWidget.make("analytics")
                .title("Signal analytics")
                .subtitle("Roll-up")
                .description(
                    "KPI cards and breakdowns from the analytics pipeline."
                )
