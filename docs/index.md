...
**Latest release:** [v1.3.0](releases/v1.3.0.md) — list bulk actions,
**DetailView**, list row actions, IDE stubs for fluent ORM fields. See
...
| Version | Highlights |
|---------|------------|
| [Unreleased](releases/unreleased.md) | *(none yet after v1.3.0)* |
