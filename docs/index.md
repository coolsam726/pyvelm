...
**Latest release:** [v1.1.0](releases/v1.1.0.md) — nested menu groups
(`m.group(...).children([...])`). Docs are [versioned](versioning.md) (use the
header picker for older lines).
...
| Version | Highlights |
|---------|------------|
| [v1.1.0](releases/v1.1.0.md) | **Nested menu groups** — `MenuBranch.children()`; automatic `parent=` |
