...
- **[Form UX](../form-ux.md)** — notebooks, sticky bar, Ctrl+S, toasts, `PvDialog`
- [One2many on parent forms](../one2many-forms.md) — `edit_toggle`, inline grid keys
- [Building UIs](../views.md)
- [Geo data](../geo-data.md) — country form notebook example
