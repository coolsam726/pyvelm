...
**v1.0** adds a portable database layer, Laravel-style **seeders**, and declarative
**Schema** migrations. See the [docs](https://coolsam726.github.io/pyvelm/) (version
picker for 1.0 vs 0.26).
